...
class nginx-setup {
    ...
    file { '/etc/nginx/sites-available/default':
        ...
        mode   => 644,
        source => '/vagrant/sf2-vagrant/files/nginx/default',
...
class php-setup {
    ...
    file { '/etc/php5/cli/php.ini':
        ...
        mode   => 644,
        source => '/vagrant/sf2-vagrant/files/php/cli/php.ini',
        require => Package[$php],
    }
    ...
    file { '/etc/php5/fpm/php.ini':
        ...
        mode   => 644,
        source => '/vagrant/sf2-vagrant/files/php/fpm/php.ini',
        require => Package[$php],
    }
    ...
    file { '/etc/php5/fpm/php-fpm.conf':
        ...
        mode   => 644,
        source => '/vagrant/sf2-vagrant/files/php/fpm/php-fpm.conf',
        require => Package[$php],
    }
    ...
    file { '/etc/php5/fpm/pool.d/www.conf':
        ...
        mode   => 644,
        source => '/vagrant/sf2-vagrant/files/php/fpm/pool.d/www.conf',
        require => Package[$php],
    }
